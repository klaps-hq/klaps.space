  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: "bg-white [&>button]:text-black [&>button]:font-semibold",
        range_end: "bg-white [&>button]:text-black [&>button]:font-semibold",
        range_middle: "bg-white/15 [&>button]:text-white",
        selected: "[&>button]:text-black",
        today:
